...
<div class="peers ai-s fxw-nw h-100vh">
  <div class="d-n@sm- peer peer-greed h-100 pos-r bgr-n bgpX-c bgpY-c bgsz-cv"  style="background-image: url({{ asset(config('onion_engine.options.public_assets_path')) }}/dashboard/assets/static/images/bg.jpg)">
